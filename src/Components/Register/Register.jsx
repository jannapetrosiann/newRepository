...
const Register = () => {
    ...
    return <div className={s.reg}>
        ...
        <form className={s.form} onSubmit={submit}>
            ...
            <input name="firstName" value={creds.firstName} onChange={handleChange} placeholder='First name'></input>
            <input name="lastName" value={creds.lastName} onChange={handleChange} placeholder='Last name'></input>
            <input name="username" value={creds.username} onChange={handleChange} type='text' placeholder='Username'></input>
            <input name="password" value={creds.password} onChange={handleChange} placeholder='Password'
